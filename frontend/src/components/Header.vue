<template>
  <header class="border-bottom">
    ...
    <b-row class="py-2">
      <b-col cols="4" class="logo-ene d-flex align-item-center pl-5">
        <a href="http://www.enesolucoes.com.br/"></a>

        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="70" viewBox="0 0 249 180">
      ...
      <b-col cols="4" class="img-ene d-flex align-item-center">
      ...
      <b-col cols="4" class="link-ene d-flex align-item-center justify-content-end pr-5">
        <b-button variant="dark link" href="http://www.enesolucoes.com.br/" class="my-auto">ADMIN</b-button>
      </b-col>
    </b-row>
